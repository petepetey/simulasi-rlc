...
st.set_page_config(page_title='Proyek Persamaan Diferensial', layout='wide')
st.markdown("""
# ⚡ Proyek Persamaan Diferensial
### Analisis Rangkaian RLC Seri dengan Model Persamaan Diferensial dan Visualisasi Interaktif
---
**Disusun oleh:**  
